      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 -mb-px">
          ...
          <div className="flex">
            ...
            {/* Hamburger button */}
            <button
              className={i18n.language == "fr" ? "text-slate-500 hover:text-slate-600 lg:hidden" : "absolute right-0 z-10 drtl text-slate-500 hover:text-slate-600 lg:hidden"}
          ...
          {/* Header: Right side */}
          <div className={i18n.language == "fr" ? "flex items-center" : "flex absolute left-0 drtl"}>
          <div className="flex gap-x-3 mx-5">
              <button onClick={() => i18n.changeLanguage('fr')} className="">Français</button>
              <button onClick={() => i18n.changeLanguage('ar')} className="">العربية</button>
            </div>
            <button
